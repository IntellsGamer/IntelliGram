...
MESSAGES_GET_TOP_REACTIONS_CONSTRUCTOR = 0xBB8125BA
...
UPDATE_PAID_REACTION_PRIVACY_CONSTRUCTOR = 0x8B725FCE
PAID_REACTION_PRIVACY_ANONYMOUS_CONSTRUCTOR = 0x1F0C1AD9
PAID_REACTION_PRIVACY_DEFAULT_CONSTRUCTOR = 0x206AD49E
...
def encode_paid_reaction_privacy(*, constructor_id: int) -> bytes:
    return encode_uint32(constructor_id)


def encode_update_paid_reaction_privacy(private: int) -> bytes:
    return encode_uint32(UPDATE_PAID_REACTION_PRIVACY_CONSTRUCTOR) + encode_paid_reaction_privacy(
        constructor_id=private
    )
