...
| Profile and settings | Profile update, photo upload/download, full user | Edit name/about, upload profile photo, settings name/photo reload, self profile visible | **Self profile/settings, name and bio edits, and reload persistence verified; username and photo remain unverified** |
