...
| Channels | Creation, author identity, invites, username, slow mode, join request, protection | Create broadcast channel, post/reload identity, channel info, invite/public/private settings, slow mode and protection controls | **Post/reload and owner title edit immediate UI verified; title reload and description/settings controls pending** |
