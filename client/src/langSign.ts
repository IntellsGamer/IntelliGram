const lang = {
  'Login.Title': 'Sign in to IntelliGram',
  ...
  'Login.Code.SentInApp': 'We have sent you a message in IntelliGram\nwith the code.',
  ...
  'Login.ResetEmail.Text': 'You can change your login email if you are logged into IntelliGram from another device.\n\nOtherwise, if you don\'t have access to this email, you can reset it with an **SMS** code in **%s**.',
  ...
  'Login.ResetEmail.NeedPremium': 'IntelliGram Premium Required',
  'Login.ResetEmail.NeedPremiumText': 'Due to the high cost of SMS in your country, you need a **IntelliGram Premium** account to immediately reset this email via an SMS code.\n\nYou can ask a friend to gift a Premium subscription for your account',
  ...
  'Login.QR.Help1': 'Open IntelliGram on your phone',
  ...
  'Login.QR.Subtitle': 'Scan with IntelliGram app on your phone',
