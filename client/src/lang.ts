const lang = {
  ...
  'ChatAutomation.BotDescription': 'Enter the username or URL of the IntelliGram bot that you want to automatically process your chats.',
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on IntelliGram',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use IntelliGram app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts',
  ...
  'ClientPip.PlaceholderTitle': 'IntelliGram is in Picture-in-Picture',
  ...
  'Deactivated.Subtitle': 'IntelliGram supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of IntelliGram.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give IntelliGram permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'UnconfirmedAuthDeniedWarning': 'Never send your login code to anyone or you can lose your IntelliGram account!',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on IntelliGram Web. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on IntelliGram Web. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'IntelliGram is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use IntelliGram on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on IntelliGram Web. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on IntelliGram Web. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive IntelliGram Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive IntelliGram Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for IntelliGram Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, IntelliGram will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, IntelliGram automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, IntelliGram will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, IntelliGram automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, IntelliGram will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, IntelliGram automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, IntelliGram will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, IntelliGram automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by IntelliGram and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by IntelliGram and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by IntelliGram, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by IntelliGram, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by IntelliGram, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to IntelliGram Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** IntelliGram Premium subscription for %s',
    'other_value': '**%d** IntelliGram Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with IntelliGram Premium subscription for %s',
    'other_value': '**%d** %s with IntelliGram Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'IntelliGram Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'IntelliGram Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by IntelliGram.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by IntelliGram.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **IntelliGram Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to IntelliGram Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[IntelliGram Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[IntelliGram Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%1$s**, get **%2$d** more boost by gifting **IntelliGram Premium** to a friend.',
    'other_value': 'To boost **%1$s**, get **%2$d** more boosts by gifting **IntelliGram Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift IntelliGram Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[IntelliGram Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to IntelliGram Premium to restrict who can send you voice or video messages.\n\n**[What is IntelliGram Premium?]()**',
  ...
  'Privacy.GiftsPremiumError': 'Subscribe to [IntelliGram Premium]() to restrict who can send you gifts.',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [IntelliGram Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[IntelliGram Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'IntelliGram doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **IntelliGram Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to IntelliGram Premium',
  ...
  'Frozen.Violation.Subtitle': 'Your account was frozen for breaking IntelliGram’s Terms of Service.',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of IntelliGram.',
  'Verified.Channel': 'This channel was verified by IntelliGram.',
  'Verified.Group': 'This group was verified by IntelliGram.',
  'ProfileUnofficialSecurityRisk': '%1$s uses an unofficial IntelliGram client — messages to this user may be less secure.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [IntelliGram Premium]() to increase summary limits.',
  ...
  'TelegramPremiumSubscribedSubtitle': 'Thank you for subscribing to **IntelliGram Premium**.\nHere’s what is now unlocked.',
  'TelegramPremiumPeerTitle': '%s is a subscriber of **IntelliGram Premium**',
  'TelegramPremiumPeerSubtitle': 'Owners of **IntelliGram Premium** accounts have exclusive access to multiple additional features.',
  ...
  'TelegramPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **IntelliGram Premium**:',
  ...
  'ContactJoined': 'Contact joined IntelliGram',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on IntelliGram.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on IntelliGram only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **IntelliGram**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your IntelliGram account. There will be no way to restore it.',
  ...
  'TelegramFeatures': 'IntelliGram Features',
  ...
  'NoUsernameFound': 'There is no IntelliGram account with this username.',
  ...
  'ReportSentInfo': 'IntelliGram moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official IntelliGram app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'TelegramFeaturesUrl': 'https://t.me/IntelliGramTips',
  'ScamMessage': 'SCAM',
  'FakeMessage': 'FAKE',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. IntelliGram has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that IntelliGram never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **IntelliGram Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **IntelliGram Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with IntelliGram',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with IntelliGram?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with IntelliGram.',
  'TerminateWebSessionInfo': 'Click to disconnect from your IntelliGram account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **IntelliGram Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **IntelliGram Premium**.',
  ...
  'GiftTelegramPremiumTitle': 'Gift IntelliGram Premium',
  'GiftTelegramPremiumDescription': 'Give **%1$s** access to exclusive features with **IntelliGram Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive IntelliGram features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': 'IntelliGram will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has IntelliGram installed will be able to join your channel by following this link.',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with IntelliGram**. You must agree to the Terms of Use for mini apps to continue.',
  ...
  'PremiumNeededForBoosting': 'Only **IntelliGram Premium** subscribers can boost channels. Do you want to subscribe to **IntelliGram Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **IntelliGram Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of IntelliGram Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** IntelliGram Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s IntelliGram Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s IntelliGram Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s IntelliGram Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s IntelliGram Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **IntelliGram Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **IntelliGram Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **IntelliGram Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **IntelliGram Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **IntelliGram Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **IntelliGram Premium** subscription.',
  ...
  'BoostingDate': 'Date',
  'BoostingTelegramPremiumFor': 'IntelliGram Premium for %s',
  ...
  'BoostingPremium': 'IntelliGram Premium',
  'BoostingStars': 'IntelliGram Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **IntelliGram Premium**.',
  ...
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to IntelliGram Premium.',
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to IntelliGram Premium.',
  ...
  'GiftPremiumActivateErrorTitle': 'You already have IntelliGram Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to IntelliGram Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to IntelliGram Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a IntelliGram Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to IntelliGram Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to IntelliGram Premium',
  ...
  'AdHidden': 'You will no longer see ads from IntelliGram.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': 'IntelliGram Ads are very different from ads on other platforms. Ads such as this one:',
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': 'Ads on IntelliGram do not use your personal information and are based on the channel in which you see them.',
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from IntelliGram Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **IntelliGram Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can create an ad to display in this channel — with minimal budgets. Check out the **IntelliGram Ad Platform** for details. %1$s',
  ...
  'TelegramStars': 'IntelliGram Stars',
  ...
  'FactCheckToast': 'This clarification was provided by IntelliGram.',
  'FactCheckFooter': 'This clarification was provided by IntelliGram.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **IntelliGram Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on IntelliGram.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on IntelliGram.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on IntelliGram.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on IntelliGram.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on IntelliGram.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on IntelliGram and Fragment over the past month.',
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastTelegram': 'This is the price at which **%s** was last sold on IntelliGram',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on IntelliGram and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on IntelliGram and Fragment over the past month.',
  'StarGiftViewResaleTelegram': '%s for sale on IntelliGram %s',
  ...
  'Reported2': 'IntelliGram moderators will review your report. Thank you!',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on IntelliGram yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using IntelliGram search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using IntelliGram search.',
  ...
  'Chat.Service.PeerJoinedTelegram': '%@ joined IntelliGram',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, IntelliGram never uses your private data to target ads. Sponsored messages on IntelliGram are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on IntelliGram sees the same sponsored messages.\n\nUnlike other apps, IntelliGram doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nIntelliGram offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, IntelliGram developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow IntelliGram to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to IntelliGram Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make IntelliGram look amazing.',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [IntelliGram Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through IntelliGram servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'Action.SuggestedProfilePhoto': 'un1 suggests this photo for your IntelliGram profile',
  ...
  'GroupEmojiPack.LinkInfo': 'All members will be able to use these emoji in the group, even if they don\'t have IntelliGram Premium.',
  ...
  'Schedule.Repeat.PremiumRequired': 'Subscribe to **[IntelliGram Premium]()** to schedule repeating messages.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your IntelliGram account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where IntelliGram sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to IntelliGram Premium.',
  ...
  'Premium.Boarding.Title': 'IntelliGram Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **IntelliGram Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to IntelliGram Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nIntelliGram Premium',
  'Premium.Boarding.Peer.Info': 'Owners of IntelliGram Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About IntelliGram Premium',
  'Premium.Boarding.About.Text': 'While the free version of IntelliGram already gives its users more than any other messaging application, **IntelliGram Premium** pushes its capabilities even further.\n\n**IntelliGram Premium** is a paid option, because most Premium Features require additional expenses from IntelliGram to third parties such as data center providers and server manufacturers. Contributions from **IntelliGram Premium** users allow us to cover such costs and also help IntelliGram stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the IntelliGram [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for IntelliGram Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have IntelliGram Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [IntelliGram Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [IntelliGram Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [IntelliGram Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [IntelliGram Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [IntelliGram Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to IntelliGram Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your IntelliGram.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock IntelliGram.',
  ...
  'PeerInfo.AppFooterAdmin': 'By publishing this mini app, you agree to the [IntelliGram Terms of Service for Developers](https://telegram.org/privacy).',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of IntelliGram\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via IntelliGram instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on IntelliGram. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on IntelliGram. What affects it:',
  'StarsRating.Row1Title': 'Gifts from IntelliGram',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from IntelliGram.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive IntelliGram login codes via email and not SMS. Please enter an email address to which you have access.',
  ...
  'AiEditor.PremiumFlood': 'You have hit the limit for now. Subscribe to [IntelliGram Premium]() to increase the limit by 50 times or try again later.',
