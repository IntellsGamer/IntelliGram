...
const handlebarsPlugin = handlebars({
  context: {
    title: 'IntelliGram',
    description: 'IntelliGram is a self-hosted messaging application focused on security and speed.',
    url: process.env.INTELLIGRAM_PUBLIC_URL || 'http://127.0.0.1:8080/',
    origin: process.env.INTELLIGRAM_PUBLIC_ORIGIN || 'http://127.0.0.1:8080'
  }
});
